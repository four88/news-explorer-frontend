...
export default function HambergerMenu({
  ...
  return (
    <section className="hamburger">
      ...
      >
        <div
          className={`hamburger__nav_header
        ...
        >
          <div className="hamburger__nav_container">
            ...
            <button className="hamburger__button-close" onClick={onCloseMenu}>
              <img
        ...
        <ul className="hamburger__list">
          <li className="hamburger__item">
            <Link
              className={`hamburger__link hamburger__link_article
            ...
            <>
              <li
                className={`hamburger__item
                        ${
                          inArticleRoute
                            ? "hamburger__item_black hamburger__item_black-active"
                            : ""
                        }`}
              >
                <Link
              ...
              >
                {account.name}
                <img
                  src={inArticleRoute ? logOutIconBlack : logOutIconWhite}
